...
public class ExplosionAnimation extends GameObject{
	...
	static {
	 img = new Image[]{new Image("img/explosion1.png", 100, 100, true, true), new Image("img/explosion1.png", 100, 100, true, true), new Image("img/explosion2.png", 100, 100, true, true), new Image("img/explosion2.png", 100, 100, true, true), 
